...
private:
    ...
    Vector3D* TopFinInnerThinVectors = new Vector3D[3] {Vector3D(-18.1170f,-19.0705f,0.0000f),Vector3D(-31.9431f,1.9071f,0.0000f),Vector3D(20.9776f,30.0361f,-0.0000f)};
    ...
    Vector3D* ClosedEyeBrowVectors = new Vector3D[6] {Vector3D(2.5531f,6.3828f,0.0000f),Vector3D(14.3614f,10.8508f,0.0000f),Vector3D(22.6591f,-0.3191f,0.0000f),Vector3D(24.5739f,-2.2340f,0.0000f),Vector3D(19.4677f,-14.6805f,0.0000f),Vector3D(19.4677f,-14.6805f,0.0000f)};
