...
private:
    ...
    static const uint8_t morphCount = 35;
    ...
    Vector3D* HideAllVectors = new Vector3D[32] {Vector3D(9.0585f,-9.0585f,0.0000f),Vector3D(3.3373f,-11.4423f,0.0000f),Vector3D(0.9535f,-10.0120f,0.0000f),Vector3D(4.2909f,-8.5817f,0.0000f),Vector3D(3.4797f,-15.4237f,0.0000f),Vector3D(-8.7479f,-15.4594f,0.0000f),Vector3D(-5.7212f,-7.1515f,0.0000f),Vector3D(17.9593f,-17.4169f,0.0000f),Vector3D(4.3805f,-22.4955f,0.0000f),Vector3D(3.0445f,-23.6403f,0.0000f),Vector3D(10.7900f,-11.2929f,0.0000f),Vector3D(7.7612f,-11.5198f,0.0000f),Vector3D(-3.0998f,-19.0537f,0.0000f),Vector3D(38.9078f,-1.6109f,0.0000f),Vector3D(45.5825f,23.6575f,0.0000f),Vector3D(21.2676f,12.6919f,0.0000f),Vector3D(10.0835f,23.9987f,0.0000f),Vector3D(-2.0938f,2.6799f,0.0000f),Vector3D(-7.6914f,11.5534f,0.0000f),Vector3D(-20.2108f,-4.9483f,0.0000f),Vector3D(-27.5808f,-1.7466f,0.0000f),Vector3D(-49.5119f,12.5563f,0.0000f),Vector3D(-49.7701f,-17.8209f,0.0000f),Vector3D(-3.8141f,10.4888f,0.0000f),Vector3D(-4.7676f,8.1050f,0.0000f),Vector3D(-16.2099f,2.3838f,0.0000f),Vector3D(-8.5817f,-6.1979f,0.0000f),Vector3D(-5.2444f,6.6747f,0.0000f),Vector3D(6.1979f,9.0585f,0.0000f),Vector3D(14.4109f,-4.5291f,0.0000f),Vector3D(2.0587f,-8.6465f,0.0000f),Vector3D(-4.5291f,-11.7346f,0.0000f)};
    Vector3D* AlphaGenCircleVectors = new Vector3D[32] {Vector3D(9.0585f,-9.0585f,0.0000f),Vector3D(3.3373f,-11.4423f,0.0000f),Vector3D(0.9535f,-10.0120f,0.0000f),Vector3D(4.2909f,-8.5817f,0.0000f),Vector3D(3.4797f,-15.4237f,0.0000f),Vector3D(-8.7479f,-15.4594f,0.0000f),Vector3D(-5.7212f,-7.1515f,0.0000f),Vector3D(17.9593f,-17.4169f,0.0000f),Vector3D(4.3805f,-22.4955f,0.0000f),Vector3D(3.0445f,-23.6403f,0.0000f),Vector3D(10.7900f,-11.2929f,0.0000f),Vector3D(7.7612f,-11.5198f,0.0000f),Vector3D(-3.0998f,-19.0537f,0.0000f),Vector3D(4.8774f,20.8755f,0.0000f),Vector3D(19.7374f,29.1463f,0.0000f),Vector3D(7.9077f,12.2964f,0.0000f),Vector3D(1.3324f,14.1519f,0.0000f),Vector3D(-1.7166f,5.2700f,0.0000f),Vector3D(-7.6914f,11.5534f,0.0000f),Vector3D(-11.3919f,7.4419f,0.0000f),Vector3D(-14.0035f,1.2069f,0.0000f),Vector3D(-23.3880f,8.3109f,0.0000f),Vector3D(-39.4329f,9.0599f,0.0000f),Vector3D(-3.8141f,10.4888f,0.0000f),Vector3D(-4.7676f,8.1050f,0.0000f),Vector3D(-16.2099f,2.3838f,0.0000f),Vector3D(-8.5817f,-6.1979f,0.0000f),Vector3D(-5.2444f,6.6747f,0.0000f),Vector3D(6.1979f,9.0585f,0.0000f),Vector3D(14.4109f,-4.5291f,0.0000f),Vector3D(2.0587f,-8.6465f,0.0000f),Vector3D(-4.5291f,-11.7346f,0.0000f)};
    Vector3D* vrc_v_aaVectors = new Vector3D[5] {Vector3D(0.0000f,27.6883f,-0.0000f),Vector3D(0.0000f,27.6883f,-0.0000f),Vector3D(0.0000f,27.6883f,-0.0000f),Vector3D(0.0000f,27.6883f,-0.0000f),Vector3D(0.0000f,6.8156f,0.0000f)};
    Vector3D* vrc_v_chVectors = new Vector3D[3] {Vector3D(0.0000f,18.3169f,-0.0000f),Vector3D(0.0000f,18.3169f,-0.0000f),Vector3D(0.0000f,-28.1143f,0.0000f)};
    Vector3D* vrc_v_ddVectors = new Vector3D[6] {Vector3D(0.0000f,-1.7039f,0.0000f),Vector3D(0.0000f,-1.7039f,0.0000f),Vector3D(0.0000f,-14.9091f,0.0000f),Vector3D(0.0000f,-14.9091f,0.0000f),Vector3D(0.0000f,-23.8545f,0.0000f),Vector3D(-0.0000f,-23.8545f,0.0000f)};
    Vector3D* vrc_v_eeVectors = new Vector3D[7] {Vector3D(0.0000f,-8.9454f,0.0000f),Vector3D(0.0000f,-8.9454f,0.0000f),Vector3D(0.0000f,-8.9454f,0.0000f),Vector3D(-0.0000f,-17.4649f,0.0000f),Vector3D(-0.0000f,-17.4649f,0.0000f),Vector3D(-0.0000f,-17.4649f,0.0000f),Vector3D(-0.0000f,-17.4649f,0.0000f)};
    Vector3D* vrc_v_ihVectors = new Vector3D[7] {Vector3D(0.0000f,6.8156f,0.0000f),Vector3D(0.0000f,6.8156f,0.0000f),Vector3D(0.0000f,-7.6675f,0.0000f),Vector3D(0.0000f,-7.6675f,0.0000f),Vector3D(0.0000f,-7.6675f,0.0000f),Vector3D(0.0000f,6.8156f,0.0000f),Vector3D(0.0000f,6.8156f,0.0000f)};
    Vector3D* vrc_v_ohVectors = new Vector3D[6] {Vector3D(0.0000f,11.5013f,-0.0000f),Vector3D(0.0000f,14.4831f,-0.0000f),Vector3D(0.0000f,-4.2597f,0.0000f),Vector3D(-0.0000f,-34.0779f,0.0000f),Vector3D(0.0000f,1.7039f,0.0000f),Vector3D(0.0000f,3.8338f,-0.0000f)};
    Vector3D* vrc_v_ssVectors = new Vector3D[6] {Vector3D(0.0000f,-13.2052f,0.0000f),Vector3D(0.0000f,-13.2052f,0.0000f),Vector3D(0.0000f,-22.1506f,0.0000f),Vector3D(-0.0000f,-32.8000f,0.0000f),Vector3D(-0.0000f,-32.8000f,0.0000f),Vector3D(-0.0000f,-13.2052f,0.0000f)};
    Vector3D* vrc_v_rrVectors = new Vector3D[6] {Vector3D(0.0000f,19.5948f,-0.0000f),Vector3D(0.0000f,19.1688f,-0.0000f),Vector3D(0.0000f,2.5558f,0.0000f),Vector3D(0.0000f,-11.0753f,0.0000f),Vector3D(0.0000f,-11.0753f,0.0000f),Vector3D(0.0000f,19.1688f,-0.0000f)};
